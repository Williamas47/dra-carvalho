  ...
  return (
    <div className="floating-social">
      ...
      <a
        ...
        aria-label="Instagram da Dra. Eduarda Carvalho"
        className="w-14 h-14 rounded-full flex items-center justify-center shadow-2xl instagram-btn"
        title="Instagram"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="WhatsApp da Dra. Eduarda Carvalho"
        className="w-14 h-14 rounded-full flex items-center justify-center shadow-2xl whatsapp-btn pulse-whatsapp"
        title="WhatsApp"
      >
