...
export default function Contact() {
  return (
    <section id="contato" className="py-24"
      style={{ background: "linear-gradient(135deg, #3D1A3A 0%, #5E2D5B 50%, #7A4070 100%)" }}
    >
      {/* Top wave */}
      <div className="overflow-hidden leading-none -mt-24 mb-0">
        <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-12">
          <path d="M0,0 C360,60 1080,0 1440,40 L1440,0 Z" fill="#FDFAF8" />
        </svg>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 pt-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-14">
          ...
          >
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4 whatsapp-btn pulse-whatsapp">
            ...
            <span className="mt-3 text-xs font-medium" style={{ color: "#25D366" }}>
              (14) 9 9999-9999
            </span>
          </a>
          ...
          <a
            ...
            style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)" }}
          >
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4 instagram-btn">
            ...
            <p className="text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
              Dicas jurídicas e novidades
            </p>
            <span className="mt-3 text-xs font-medium" style={{ color: "#E1306C" }}>
              @{INSTAGRAM_HANDLE}
            </span>
          </a>
          ...
          >
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4"
              ...
              <MapPin size={28} style={{ color: "#3D1A3A" }} />
            </div>
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm" style={{ color: "rgba(255,255,255,0.7)" }}>contato@draEduardaCarvalho.adv.br</span>
          </div>
          <div className="flex items-center gap-3">
