        ...
        <div className='grid lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className='order-1 lg:order-2'>
            ...
            >
              ...
              <strong style={{ color: '#555555' }}>Direito Trabalhista</strong>,
              com ênfase em{' '}
              <strong style={{ color: '#555555' }}>Causas Femininas</strong>.
            </p>
            ...
            <p
              ...
              style={{ color: '#666666' }}
            >
              Pós-graduada em Direito e Processo do Trabalho, com
              especializações em{' '}
